...
namespace ProjetoDeSoftware.Alimentacao.Entidades
{
    public class Lanchonete
    {
        ...
        public Lanchonete(double _preco_medio_prato, int _capacidade, bool _ehDelivery, bool _abrangenciaApenasMinhaZona, Bairro _bairro)
        {
        ...
        public Lanchonete(double _preco_medio_prato, int _capacidade, bool _ehDelivery, bool _abrangenciaApenasMinhaZona)
        {
            preco_medio_prato = _preco_medio_prato;
            capacidade = _capacidade;
            ehDelivery = _ehDelivery;
